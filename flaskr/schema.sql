...
CREATE TABLE stest (
  ...
  guess_MBTI_EI TEXT NOT NULL,
  guess_MBTI_SN TEXT NOT NULL,
  guess_MBTI_TF TEXT NOT NULL,
  guess_MBTI_JP TEXT NOT NULL,
...
CREATE TABLE samples(
  ...
  q24 INTEGER NOT NULL,
  q25 INTEGER NOT NULL,
  real_MBTI_EI TEXT NOT NULL,
  real_MBTI_SN TEXT NOT NULL,
  real_MBTI_TF TEXT NOT NULL,
  real_MBTI_JP TEXT NOT NULL,
